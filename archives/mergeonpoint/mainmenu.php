  ...
  <div style="overflow: auto; width: 100%; height: auto; margin-top: 203px;">
    <table class="table">
      <tbody>
        ...
        <tr style="height: auto;">
          <td class="td shown" onclick="watch(145069982)">
            <img class="vid" src="images/145069982_295x166.jpg">
            <h1>Monday</h1>
            <h4>Read <a href="https://www.bible.com/bible/59/heb.12.esv">Hebrews 12</a> After Watching</h4>
          </td>
        </tr>
        <tr style="height: auto;">
          <td class="shown">
        ...
        <tr style="height: auto;">
          <td class="td shown" onclick="watch(145413383)">
            <img class="vid" src="images/145413383_295x166.jpg">
            <h1>Session 1</h1>
          </td>
        </tr>
        <tr style="height: auto;">
          <td class="td shown" onclick="watch(145429063)">
            <img class="vid" src="images/145429063_295x166.jpg">
            <h1>Session 2</h1>
          </td>
        </tr>
        <tr style="height: auto;">
          <td class="td shown" onclick="watch(145416233)">
            <img class="vid" src="images/145416233_295x166.jpg">
            <h1>Session 3</h1>
          </td>
        </tr>
        <tr style="height: auto;">
          <td class="td shown" onclick="watch(145416298)">
            <img class="vid" src="images/145416298_295x166.jpg">
            <h1>Session 4</h1>
          </td>
        </tr>
        <tr style="height: auto;">
